...
import { userOne, userTwo, UserCreator } from "./prototype-use-with-this.js";
...
test("__proto__ returns UserCreator as prototype", () => {
...
test("__proto__ returns userFunctionStore as prototype", () => {
    expect(userTwo.__proto__).toBe(UserCreator.prototype);
});

test("Object.getPrototype returns userFunctionStore as prototype", () => {
    expect(Object.getPrototypeOf(userTwo)).toBe(UserCreator.prototype);
});
